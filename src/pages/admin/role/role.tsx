...
const RolePage = () => {
    ...
    const [listPermissions, setListPermissions] = useState<PermissionGroup[] | null>(null);
        ...
        <PageContainer
            ...
            filter={
                <SearchFilter
                    ...
                    onSearch={(val) =>
                        setQuery(
                            `page=${PAGINATION_CONFIG.DEFAULT_PAGE}&size=${PAGINATION_CONFIG.DEFAULT_PAGE_SIZE}&filter=${sfLike("name", val)}`
                        )
                    }
                    onReset={reloadTable}
                    onAddClick={() => {
