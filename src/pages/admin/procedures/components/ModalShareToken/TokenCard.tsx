/**
 * TokenCard.tsx
 * Dùng để: hiển thị từng share token dạng card trên màn hình mobile
 * Dùng trong: index.tsx (thay thế Table khi isMobile = true)
 */
        ...
        <div style={{
            ...
            {expanded && (
                <div style={{ borderTop: "1px solid #e2e8f0" }}>
                    <ExpandedRow token={token} procedureCode={procedureCode} />
                </div>
            )}
        </div>
    );
