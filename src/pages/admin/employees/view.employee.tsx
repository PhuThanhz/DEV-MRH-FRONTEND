    ...
    const tabItems = [
        {
            ...
            children: (
                <div className="emp-two-col" style={{
    ...
    return (
        ...
        >
            <style>{`
                ...
                .emp-pos-row:hover td { background: #f8fafc !important; }
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        <div>
                            ...
                            <Text style={{ fontSize: 12, color: TEXT_LABEL, fontWeight: 500 }}>
                                Hồ sơ nhân sự & chức danh làm việc hệ thống HRM-LOTUS
                            </Text>
                        </div>
                    </div>
                </div>
