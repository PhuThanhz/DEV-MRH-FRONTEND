...
import { DOSSIER_GUIDES } from "./dossierGuides";
...
export type LotusGuideStep = {
    ...
    inModal?: boolean; // true nếu element nằm bên trong Ant Design modal
};
...
export const LOTUS_GUIDES: LotusGuide[] = [
    {
        ...
        module: "Kế toán",
        subModule: "Chứng từ",
        routePrefix: "/admin/accounting-documents",
        exactRoute: true,
    ...
    },
    {
                ...
                targetId: ".employee-detail-modal .ant-modal-content",
    ...
    },
    {
                                                    ...
                                                    targetId: ".document-view-modal .ant-modal-content",
